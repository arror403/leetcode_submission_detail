<h1>3819 - Count Covered Buildings</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/count-covered-buildings/">count-covered-buildings</a></h2><p>You are given a positive integer <code>n</code>, representing an <code>n x n</code> city. You are also given a 2D grid <code>buildings</code>, where <code>buildings[i] = [x, y]</code> denotes a <strong>unique</strong> building located at coordinates <code>[x, y]</code>.</p>
