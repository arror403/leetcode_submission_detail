<h1>763 - Special Binary String</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/special-binary-string/">special-binary-string</a></h2><p><strong>Special binary strings</strong> are binary strings with the following two properties:</p>
