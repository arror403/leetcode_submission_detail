<h1>3540 - Hash Divided String</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/hash-divided-string/">hash-divided-string</a></h2><p>You are given a string <code>s</code> of length <code>n</code> and an integer <code>k</code>, where <code>n</code> is a <strong>multiple</strong> of <code>k</code>. Your task is to hash the string <code>s</code> into a new string called <code>result</code>, which has a length of <code>n / k</code>.</p>
