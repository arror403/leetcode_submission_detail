<h1>3827 - Implement Router</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/implement-router/">implement-router</a></h2><p>Design a data structure that can efficiently manage data packets in a network router. Each data packet consists of the following attributes:</p>
