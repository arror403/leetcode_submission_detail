<h1>3892 - Best Time to Buy and Sell Stock V</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/best-time-to-buy-and-sell-stock-v/">best-time-to-buy-and-sell-stock-v</a></h2><p>You are given an integer array <code>prices</code> where <code>prices[i]</code> is the price of a stock in dollars on the <code>i<sup>th</sup></code> day, and an integer <code>k</code>.</p>
