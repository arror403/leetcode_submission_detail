<h1>1196 - Filling Bookcase Shelves</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/filling-bookcase-shelves/">filling-bookcase-shelves</a></h2><p>You are given an array <code>books</code> where <code>books[i] = [thickness<sub>i</sub>, height<sub>i</sub>]</code> indicates the thickness and height of the <code>i<sup>th</sup></code> book. You are also given an integer <code>shelfWidth</code>.</p>
