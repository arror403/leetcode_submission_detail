<h1>2028 - The Earliest and Latest Rounds Where Players Compete</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/the-earliest-and-latest-rounds-where-players-compete/">the-earliest-and-latest-rounds-where-players-compete</a></h2><p>There is a tournament where <code>n</code> players are participating. The players are standing in a single row and are numbered from <code>1</code> to <code>n</code> based on their <strong>initial</strong> standing position (player <code>1</code> is the first player in the row, player <code>2</code> is the second player in the row, etc.).</p>
