<h1>2508 - Maximum Sum of an Hourglass</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-sum-of-an-hourglass/">maximum-sum-of-an-hourglass</a></h2><p>You are given an <code>m x n</code> integer matrix <code>grid</code>.</p>
