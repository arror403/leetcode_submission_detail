<h1>835 - Linked List Components</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/linked-list-components/">linked-list-components</a></h2><p>You are given the <code>head</code> of a linked list containing unique integer values and an integer array <code>nums</code> that is a subset of the linked list values.</p>
