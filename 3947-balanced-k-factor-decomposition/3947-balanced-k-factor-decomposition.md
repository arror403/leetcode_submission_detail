<h1>3947 - Balanced K-Factor Decomposition</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/balanced-k-factor-decomposition/">balanced-k-factor-decomposition</a></h2><p>Given two integers <code>n</code> and <code>k</code>, split the number <code>n</code> into exactly <code>k</code> positive integers such that the <strong>product</strong> of these integers is equal to <code>n</code>.</p>
