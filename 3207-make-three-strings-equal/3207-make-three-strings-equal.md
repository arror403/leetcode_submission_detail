<h1>3207 - Make Three Strings Equal</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/make-three-strings-equal/">make-three-strings-equal</a></h2><p>You are given three strings: <code>s1</code>, <code>s2</code>, and <code>s3</code>. In one operation you can choose one of these strings and delete its <strong>rightmost</strong> character. Note that you <strong>cannot</strong> completely empty a string.</p>
