<h1>1732 - Minimum One Bit Operations to Make Integers Zero</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/minimum-one-bit-operations-to-make-integers-zero/">minimum-one-bit-operations-to-make-integers-zero</a></h2><p>Given an integer <code>n</code>, you must transform it into <code>0</code> using the following operations any number of times:</p>
