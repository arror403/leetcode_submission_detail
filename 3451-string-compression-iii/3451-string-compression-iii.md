<h1>3451 - String Compression III</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/string-compression-iii/">string-compression-iii</a></h2><p>Given a string <code>word</code>, compress it using the following algorithm:</p>
