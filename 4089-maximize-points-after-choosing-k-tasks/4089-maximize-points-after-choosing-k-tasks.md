<h1>4089 - Maximize Points After Choosing K Tasks</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximize-points-after-choosing-k-tasks/">maximize-points-after-choosing-k-tasks</a></h2><p>You are given two integer arrays, <code>technique1</code> and <code>technique2</code>, each of length <code>n</code>, where <code>n</code> represents the number of tasks to complete.</p>
