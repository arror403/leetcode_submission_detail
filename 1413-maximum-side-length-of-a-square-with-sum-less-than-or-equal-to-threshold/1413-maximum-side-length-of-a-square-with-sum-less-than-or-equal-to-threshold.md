<h1>1413 - Maximum Side Length of a Square with Sum Less than or Equal to Threshold</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold/">maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold</a></h2><p>Given a <code>m x n</code> matrix <code>mat</code> and an integer <code>threshold</code>, return <em>the maximum side-length of a square with a sum less than or equal to </em><code>threshold</code><em> or return </em><code>0</code><em> if there is no such square</em>.</p>
