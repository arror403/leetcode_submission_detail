<h1>3515 - Find if Digit Game Can Be Won</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/find-if-digit-game-can-be-won/">find-if-digit-game-can-be-won</a></h2><p>You are given an array of <strong>positive</strong> integers <code>nums</code>.</p>
