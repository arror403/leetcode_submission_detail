<h1>3493 - Maximum Number of Operations to Move Ones to the End</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-number-of-operations-to-move-ones-to-the-end/">maximum-number-of-operations-to-move-ones-to-the-end</a></h2><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
