<h1>3533 - Snake in Matrix</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/snake-in-matrix/">snake-in-matrix</a></h2><p>There is a snake in an <code>n x n</code> matrix <code>grid</code> and can move in <strong>four possible directions</strong>. Each cell in the <code>grid</code> is identified by the position: <code>grid[i][j] = (i * n) + j</code>.</p>
